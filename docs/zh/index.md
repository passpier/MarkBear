    ...
    <div class="pd-demo-wrap">
      <div class="pd-demo-frame">
        <video class="pd-demo-video" controls preload="none" playsinline poster="/demo-poster.webp" width="1108" height="720">
          ...
          <a href="/Pourdown/demo.mp4">觀看匯入示範</a>
        </video>
      </div>
...
<section id="formats" class="pd-section pd-section-alt">
  <div class="pd-container">
    ...
    <p class="pd-format-foot">確切保留哪些內容與目前的限制，請見 <a href="/Pourdown/zh/guide/importing">匯入指南 →</a></p>
  </div>
</section>
  ...
  <div class="pd-container">
    <div class="pd-llm-band">
      <div class="pd-llm-inner">
        ...
        <p class="pd-llm-sub">餵給語言模型時，Markdown 比原始 PDF 最多可節省 96% 的 token（<a href="/Pourdown/zh/guide/importing#為什麼要匯入成-markdown">社群基準測試</a>）。轉換一次，往後每次 prompt 都更省。</p>
      </div>
    </div>
  </div>
</section>
